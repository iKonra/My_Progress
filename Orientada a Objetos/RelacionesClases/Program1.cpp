...
int main() {
	...
	cout << "Ingrese el nombre: ";cin >> dnombre;
	cout << "\nIngrese el apellido: "; cin >> dapellido ;
	cout << "\nIngrese la fecha de nacimiento (A�o,Mes,Dia) : ";cin >> dNacimiento.anio >> dNacimiento.mes >> dNacimiento.dia;
	fecha dingreso;
	Docente D(dnombre,dapellido,dNacimiento);
	cout << "Ingrese el a�o, mes y dia de ingreso: "; cin >> dingreso.anio >> dingreso.mes >> dingreso.dia;
