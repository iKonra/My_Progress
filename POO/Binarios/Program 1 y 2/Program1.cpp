// ) Escriba a trav?s de un programa C++ un archivo binario llamado grupo.dat, formado por un conjunto de 200 pares
//	de n?meros generados aleatoriamente. Cada par de datos se conforma por un entero y un flotante.
